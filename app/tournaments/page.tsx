...
import { TrophyIcon as Trophy, MapPinIcon as MapPin, SignalIcon as Activity, CalendarIcon as Calendar, ChevronRightIcon as ChevronRight } from "@heroicons/react/24/solid";
        ...
        <div className="min-h-screen bg-background flex flex-col">
            <main className="flex-1 p-4 md:p-6 lg:p-8 max-w-5xl mx-auto w-full space-y-12">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-3xl font-black text-foreground uppercase tracking-tighter">Tournaments</h1>
                        <p className="text-muted-foreground text-xs font-bold uppercase tracking-widest mt-1">Explore all inter-school competitions</p>
                    </div>
                </div>
                ...
                {sportsList.length === 0 ? (
                    <div className="flex flex-col items-center justify-center py-24 bg-card/40 border border-border/50 rounded-[2.5rem] text-center space-y-4">
                        ...
                        <p className="text-muted-foreground font-bold uppercase text-xs tracking-widest">No active tournaments found</p>
                    </div>
                ) : (
