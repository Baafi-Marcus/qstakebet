...
import { ShieldCheckIcon as Shield, EyeIcon as Eye, LockClosedIcon as Lock, DocumentTextIcon as FileText, CheckBadgeIcon as UserCheck, CircleStackIcon as Cookie, ArrowLeftIcon as ArrowLeft } from "@heroicons/react/24/solid";
            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="bg-card/40 border border-border/50 rounded-[2rem] p-8 md:p-12 shadow-2xl backdrop-blur-xl">
                    ...
                    <div className="space-y-12">
                        ...
                        <section>
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <h2 className="text-2xl font-black text-foreground uppercase tracking-tight">2. Purpose of Data Collection</h2>
                            </div>
                            <div className="space-y-4 text-muted-foreground leading-relaxed">
                        ...
                        <section>
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <h2 className="text-2xl font-black text-foreground uppercase tracking-tight">6. User Rights</h2>
                            </div>
                            <div className="space-y-4 text-muted-foreground leading-relaxed">
                    ...
                    <div className="mt-16 flex flex-col sm:flex-row items-center justify-between gap-6 border-t border-border/50 pt-8">
                        <Link href="/terms" className="flex items-center gap-2 text-emerald-500 hover:text-foreground font-bold transition-all uppercase tracking-widest text-xs">
