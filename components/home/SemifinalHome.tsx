...
export function SemifinalHome({ initialMatches, sfContests, sfDeadline, qfRecap, semiFinalTop, quarterFinalTop }: SemifinalHomeProps) {
    ...
    const qfGrouped = useMemo(() => {
        const groups: { [key: string]: SemifinalHomeProps["qfRecap"] } = {}
