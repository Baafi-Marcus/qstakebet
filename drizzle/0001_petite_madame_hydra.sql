...
ALTER TABLE "schools" ADD COLUMN "tier" integer DEFAULT 4 NOT NULL;--> statement-breakpoint
ALTER TABLE "schools" ADD COLUMN "credit_cost" integer DEFAULT 10 NOT NULL;--> statement-breakpoint
...
ALTER TABLE "fantasy_lineups" ADD CONSTRAINT "fantasy_lineups_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "fantasy_lineups" ADD CONSTRAINT "fantasy_lineups_school1_id_schools_id_fk" FOREIGN KEY ("school1_id") REFERENCES "public"."schools"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "fantasy_lineups" ADD CONSTRAINT "fantasy_lineups_school2_id_schools_id_fk" FOREIGN KEY ("school2_id") REFERENCES "public"."schools"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "fantasy_lineups" ADD CONSTRAINT "fantasy_lineups_school3_id_schools_id_fk" FOREIGN KEY ("school3_id") REFERENCES "public"."schools"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "scraped_results" ADD CONSTRAINT "scraped_results_match_id_matches_id_fk" FOREIGN KEY ("match_id") REFERENCES "public"."matches"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
