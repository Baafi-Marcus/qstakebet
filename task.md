...
## Phase 48: Layout Correction & Bonus Debugging [/]
- [ ] Fix `MatchDetailsModal` top space/bottom-sheet layout
- [ ] Ensure `BetSlipSidebar` summary is always visible at bottom
- [ ] Fix `VirtualsBetSlip` Kickoff bar visibility on mobile
- [ ] Reduce `MIN_STAKE` validation to allow bonus placement
- [ ] Verify bonus bet placement flow
