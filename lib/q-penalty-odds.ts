...
export function generateQPenaltyMarkets(outcome: QPenaltyMatchOutcome): QPenaltyMarket[] {
    ...
    // 1. Match Winner (1X2) - ~14% margin
    markets.push({
        id: '1x2',
        name: 'Match Winner',
        description: 'Predict the winner of the shootout.',
        selections: [
            { id: 'winner-a', label: outcome.teamA.shortName, odds: 1.75 },
            { id: 'winner-b', label: outcome.teamB.shortName, odds: 1.75 }
        ]
    })
    ...
    markets.push({
        ...
        selections: [
            { id: 'ov-5.5', label: 'Over 5.5', odds: 1.30 },
            { id: 'un-5.5', label: 'Under 5.5', odds: 2.30 },
            { id: 'ov-7.5', label: 'Over 7.5', odds: 1.80 },
    ...
    markets.push({
        ...
        selections: [
            { id: 'btts-yes', label: 'Yes', odds: 1.45 },
            { id: 'btts-no', label: 'No', odds: 2.10 }
        ]
    })
    ...
    markets.push({
        ...
        selections: [
            { id: 'sd-yes', label: 'Yes', odds: 2.80 },
            { id: 'sd-no', label: 'No', odds: 1.20 }
        ]
    })
    ...
    markets.push({
        ...
        selections: [
            { id: 'miss-a', label: outcome.teamA.shortName, odds: 1.75 },
            { id: 'miss-b', label: outcome.teamB.shortName, odds: 1.75 }
        ]
    })
